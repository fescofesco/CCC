#%%
def freeOrTrapped(grid_string, w_row, w_col):
...
if __name__ == "__main__":
    ...
    grid_string = [['X', 'X', 'X', 'O', 'X', 'O', 'X', 'O', 'O', 'X', ''], ['', 'X', 'O', 'X', 'X', 'O', 'O', 'O', 'O', 'O', 'O'], ['X', 'X', 'O', 'W', 'O', 'O', 'O', 'X', 'O', 'X', ''], ['', 'X', 'X', 'O', 'X', 'X', 'X', 'X', 'O', 'O', 'O'], ['X', 'X', 'O', 'O', 'X', 'O', 'X', 'X', 'O', 'O', ''], ['', 'O', 'O', 'O', 'O', 'O', 'X', 'X', 'X', 'O', 'O'], ['O', 'O', 'X', 'O', 'X', 'O', 'O', 'X', 'O', 'O', ''], ['', 'X', 'O', 'X', 'O', 'X', 'O', 'X', 'X', 'O', 'X']]
